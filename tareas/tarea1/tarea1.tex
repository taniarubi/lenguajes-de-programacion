...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        Con este paradigma se pueden abarcar diferentes problemas tales como 
        aplicaciones de escritorio, aplicaciones científicas, en particular 
        simulaciones. También se pueden abarcar problemas donde sólo hay que 
        dar las instrucciones de cómo hacer las cosas en forma de algoritmo.
        
        Así, podríamos utilizar el lenguaje \textit{C} para resolver éstos 
        problemas.
        ...
        Con este paradigma se pueden abarcar diferentes problemas tales como 
        simulación de eventos simultáneos, aplicaciones de escritorio, 
        móviles y web. También se pueden abarcar problemas donde querramos ver 
        algo como un objeto (con compartamiento y atributos), como podría ser
        el caso de un robot. 

        Así, podríamos utilizar el lenguaje \textit{Java} para resolver éstos 
        problemas. 
        ...
        Con este paradigma se pueden abarcar diferentes problemas tales como 
        representación de expresiones simbólicas, además que tiene aplicaciones 
        en la industria aeroespacial, de finanzas y algunas empresas de diseño 
        de hardware. También es muy bueno cuando se intentan resolver problemas 
        de corte más matemáticos, ya que con saber implementar las definiciones 
        que nos brindan podríamos resolver nuestro problema. 
        
        Así, podríamos utilizar el lenguaje \textit{LISP} para resolver éstos 
        problemas. 
        ...
        Con este paradigma se pueden abarcar diferentes problemas tales como 
        desarrollo de aplicaciones de inteligencia artificial, prueba de teoremas 
        de forma automática, construcción de sistemas expertos, procesamiento del 
        lenguaje natural, resolución de laberintos o puzzles, etc.
        
        Así, podríamos utilizar el lenguaje \textit{Prolog} para resolver éstos 
        problemas. 
    \end{enumerate}
    ...
    % Ejercicio 3.
    \item Dada la siguiente función, da una firma para la misma indicando el 
    ...
    Por las operaciones que se manejan en el \texttt{cond} podemos notar que $n$ 
    es un número y $l$ una lista, además que este número nos sirve como contador 
    para cada llamada recursiva del método dentro de este mismo, en las cuales 
    mientras $n$ sea distinto de $0$ se aplicara \texttt{car} a la lista, lo que 
    nos dará el primer elemento y volveremos a aplicar esta función pero ahora 
    restándole 1 a $n$ y pasando al \texttt{cdr} de la lista original como 
    parámetro, lo que nos seguirá regresando elementos hasta que $n$ sea igual a 
    cero y nos regrese la lista vacía. Este algoritmo nos regresa los primeros 
    $n$ elementos de la lista que pasamos como parámetro.
    
    Y la firma de esta funcion quedaría de la siguiente forma:
    
    \begin{verbatim}
    ;;Función que recibe un numero n y una lista l y devuelve una lista con los 
    primeros n elementos de la lista pasada como parametro.
    ;;primeros-n-elementos: number (listof a) -> (listof a)
    \end{verbatim}
    ...
    \begin{tabular}{| p{9cm} | p{9cm} |}
        \hline
        Interprete & Compilador  \\ \hline
        Ejecuta directamente las instrucciones escritas en un lenguaje de 
        programación & Transforma el código fuente de un programa a su 
        equivalente en otro lenguaje de mas bajo nivel\\  \hline
        El código se traduce durante el tiempo de ejecución & El código se 
        traduce antes de ejecutar  \\ \hline
        Se traduce linea por linea  & Se traduce siempre todo el código \\ \hline
        Manda errores después de cada linea  & Manda los errores en conjunto, 
        después de la compilación \\ \hline
